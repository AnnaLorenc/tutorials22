...
#covid_data <- read_csv( "data/covid_just_in_case.csv")
...
lapply() applies a function on each elemment of a list separately. Other ways of applying a function to list elements you may encounter is with help of map() or a loop for(...){function()}
