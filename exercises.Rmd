...
Open `/media/penelopeprime/Bioinfo-T-Cell-Immunology-July22/Day1/tutorials22/exercises.nb.html` in a browser. You are in the middle of the first exercise:).
...
Change working directory to `/media/penelopeprime/Bioinfo-T-Cell-Immunology-July22/Day1/tutorials22/R_intro/working_dir`
...
Start jupyter notebook `/media/penelopeprime/Bioinfo-T-Cell-Immunology-July22/Day1/tutorials22/Python_intro/intro_to_python.ipynb`
```{bash}
jupyter notebook /media/penelopeprime/Bioinfo-T-Cell-Immunology-July22/Day1/tutorials22/Python_intro/intro_to_python.ipynb
```
...
Please save your files on your VM machine disk. Do not write on `penelopeprime`, as this is a shared location (so you can overwrite someone else's file).
Create a structure for your work: directories for code, data, results. At the end of the course you can create a personal directory on `penelopeprime`, where you can copy your code files. After the course we will make `penelopeprime` content available via ftp.

## Exercise 2 - Python with jupyter notebook

At the bottom of the notebook, add a new section 'Exercise during the course'. 
Load the package pandas and read in the `20-07-25patients_metadatav2.csv` file with patient metadata. This file is in `/media/penelopeprime/Bioinfo-T-Cell-Immunology-July22/Day1/tutorials22/R_intro/working_dir/data/`.

```{python}
import pandas as pd

file = '/media/penelopeprime/Bioinfo-T-Cell-Immunology-July22/Day1/tutorials22/R_intro/working_dir/data/20-07-25patients_metadatav2.csv'
...
results_file = "~/results/females_low.csv"
...
metadata_loc <- "/media/penelopeprime/Bioinfo-T-Cell-Immunology-July22/Day1/tutorials22/R_intro/working_dir/data/20-07-25patients_metadatav2.csv"
